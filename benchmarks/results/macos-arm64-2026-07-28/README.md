...
- Relify source revision: `aad9580544c1f8ccffdfd9bb511c46680b3e10ae`
...
- Software: Python 3.12.13, Rust 1.96.0, Relify 0.1.0, Faiss 1.14.3

## Persisted Build

Both timers start from the same uncompressed Parquet source. Relify stops after
...
|---:|---|---:|---:|---:|---:|
| 100,000 | Relify | 0.285 | 351,010 | 65.5 | 0.268 |
| 100,000 | Faiss | 0.322 | 310,438 | 49.7 | 0.276 |
| 500,000 | Relify | 0.865 | 577,870 | 325.9 | 0.274 |
| 500,000 | Faiss | 0.576 | 868,230 | 248.1 | 0.270 |
| 1,000,000 | Relify | 1.608 | 621,828 | 651.7 | 0.306 |
...
Faiss is reopened with `read_index`; Relify is reopened through a new session
and its complete index snapshot is decoded into Arrow memory. Index loading is
outside query latency. At 1M vectors, Relify retained approximately 530.6 MiB
...
|---:|---:|---|---:|---:|---:|
| 100 | 16 | Relify | 0.2582 | 15.158 | 16.551 |
| 100 | 16 | Faiss | 0.2482 | 0.577 | 0.613 |
| 1,000 | 16 | Relify | 0.2111 | 15.105 | 16.564 |
| 1,000 | 16 | Faiss | 0.2092 | 0.766 | 0.778 |
| 10,000 | 16 | Relify | 0.1688 | 17.071 | 19.433 |
| 10,000 | 16 | Faiss | 0.1670 | 2.381 | 2.410 |
| 100 | 256 | Relify | 1.0000 | 24.980 | 26.606 |
| 100 | 256 | Faiss | 1.0000 | 7.820 | 8.394 |
| 1,000 | 256 | Relify | 1.0000 | 27.425 | 28.307 |
| 1,000 | 256 | Faiss | 1.0000 | 8.106 | 8.567 |
| 10,000 | 256 | Relify | 1.0000 | 40.515 | 43.851 |
