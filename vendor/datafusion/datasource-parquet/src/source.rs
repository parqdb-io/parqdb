...
use crate::{ParquetFileReaderFactory, ParquetPageCacheFactory};
...
pub struct ParquetSource {
    ...
    pub(crate) parquet_page_cache_factory: Option<Arc<dyn ParquetPageCacheFactory>>,
...
impl ParquetSource {
    ...
    /// Sets the factory for file-scoped decompressed Parquet Page caches.
    pub fn with_parquet_page_cache_factory(
        mut self,
        parquet_page_cache_factory: Arc<dyn ParquetPageCacheFactory>,
    ) -> Self {
        self.parquet_page_cache_factory = Some(parquet_page_cache_factory);
        self
    }
...
impl FileSource for ParquetSource {
    ...
    fn create_morselizer(
        ...
        Ok(Box::new(ParquetMorselizer {
            ...
            parquet_page_cache_factory: self.parquet_page_cache_factory.clone(),
