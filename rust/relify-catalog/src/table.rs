...
/// One catalog implementation that owns both table definitions and Relify indexes.
pub trait RelifyCatalog: IndexCatalog + TableCatalog {}

impl<T> RelifyCatalog for T where T: IndexCatalog + TableCatalog {}
