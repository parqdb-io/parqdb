//! Embedded `ParqDB` session composition.
...
use self::catalog_list::ParqDBCatalogList;
#[cfg(test)]
...
use crate::runtime::ParqDBRuntime;
...
pub struct IndexInfo {
    ...
    /// Current `ParqDB` index snapshot ID.
...
impl LocalSession {
    ...
    #[must_use]
    pub fn runtime(&self) -> Arc<ParqDBRuntime> {
