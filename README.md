...
From a new working directory, build a source-backed IVF index over the dataset
...
| Spark Classic | Batch | Query source-encoded L2 Parquet and Iceberg indexes | Experimental |
| StarRocks | OLAP | Query source-encoded L2 Iceberg indexes over Arrow Flight SQL | Experimental |
