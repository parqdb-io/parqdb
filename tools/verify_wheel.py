...
def verify_wheel(repository: Path, wheel: Path) -> None:
    ...
    with ZipFile(wheel) as archive:
        ...
        required_package_files = {
            ...
            "relify/experimental/__init__.py",
            "relify/experimental/spark/__init__.py",
            "relify/experimental/spark/planner.py",
            "relify/experimental/starrocks/__init__.py",
            "relify/experimental/starrocks/planner.py",
            "relify/py.typed",
