...
if TYPE_CHECKING:
    ...
    from relify.datafusion import DataFrame, SessionContext
    from relify.datafusion.context import TableProviderExportable
    from relify.datafusion.expr import CreateExternalTable
