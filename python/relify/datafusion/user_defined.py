...
import relify.datafusion._internal as df_internal
from relify.datafusion import SessionContext
from relify.datafusion.expr import Expr
...
class ScalarUDF:
    ...
    def name(self) -> str:
        ...
        Examples:
            >>> import pyarrow as pa
            >>> from relify.datafusion import udf
            >>> double = udf(
    ...
    def udf(*args: Any, **kwargs: Any):  # noqa: D417
        ...
        Examples:
            ...
            >>> from relify.datafusion.user_defined import ScalarUDF
            >>> def double_func(x):
...
class AggregateUDF:
    ...
    def udaf(*args: Any, **kwargs: Any):  # noqa: D417, C901
        ...
        Examples:
            >>> import pyarrow.compute as pc
            >>> from relify.datafusion.user_defined import AggregateUDF, Accumulator, udaf
...
class WindowUDF:
    ...
    def udwf(*args: Any, **kwargs: Any):  # noqa: D417
        ...
        Examples:
            >>> from relify.datafusion.user_defined import WindowUDF, WindowEvaluator, udwf
