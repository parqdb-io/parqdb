...
from relify.datafusion._internal import DataFrame as DataFrameInternal
from relify.datafusion._internal import DataFrameWriteOptions as DataFrameWriteOptionsInternal
from relify.datafusion._internal import InsertOp as InsertOpInternal
from relify.datafusion._internal import ParquetColumnOptions as ParquetColumnOptionsInternal
from relify.datafusion._internal import ParquetWriterOptions as ParquetWriterOptionsInternal
from relify.datafusion.expr import (
    Expr,
    SortExpr,
    SortKey,
    _to_raw_expr,
...
from relify.datafusion.record_batch import RecordBatch, RecordBatchStream
...
if TYPE_CHECKING:
    ...
    from relify.datafusion.catalog import Table
...
class DataFrame:
    ...
    def into_view(self, temporary: bool = False) -> Table:
        ...
        Examples:
            ...
            [1]
        """
        from relify.datafusion.catalog import Table as _Table  # noqa: PLC0415
    ...
    def window(self, *exprs: Expr) -> DataFrame:
        ...
        Examples:
            ...
            >>> import relify.datafusion.functions as f
            >>> from relify.datafusion import col
            >>> ctx = dfn.SessionContext()
    ...
    def explain(
        ...
        Examples:
            ...
            >>> from relify.datafusion import ExplainFormat
            >>> ctx = dfn.SessionContext()
            >>> df = ctx.from_pydict({"a": [1, 2, 3]})
