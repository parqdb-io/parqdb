"""Deployment configuration for a ParqDB server."""
...
DEFAULT_CONFIG_FILENAME = "parqdb.toml"

DEFAULT_CONFIG_TEMPLATE = """# ParqDB server configuration.
#
# Run `parqdb serve` in this directory, or pass this file with --config.
...
# ParqDB and DataFusion session options. Values are strings because they map
...
def load_server_config(path: str | Path) -> ServerConfig:
    """Load one ParqDB server TOML file with strict shape validation."""
...
def _from_document(raw: object, directory: Path) -> ServerConfig:
    ...
    root = _local_path(server.get("root", "./parqdb"), "server.root", directory)
