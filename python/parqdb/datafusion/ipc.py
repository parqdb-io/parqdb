...
.. code-block:: python
    ...
    from parqdb.datafusion.ipc import set_worker_ctx
...
>>> import pickle
>>> from parqdb.datafusion import SessionContext, col, lit
>>> from parqdb.datafusion.ipc import clear_sender_ctx, set_sender_ctx
...
if TYPE_CHECKING:
    from parqdb.datafusion.context import SessionContext
...
def set_worker_ctx(ctx: SessionContext) -> None:
    ...
    Examples:
        >>> from parqdb.datafusion import SessionContext
        >>> from parqdb.datafusion.ipc import set_worker_ctx, get_worker_ctx, clear_worker_ctx
...
def clear_worker_ctx() -> None:
    ...
    Examples:
        >>> from parqdb.datafusion import SessionContext
        >>> from parqdb.datafusion.ipc import set_worker_ctx, clear_worker_ctx, get_worker_ctx
        >>> set_worker_ctx(SessionContext())
        >>> clear_worker_ctx()
...
def get_worker_ctx() -> SessionContext | None:
    ...
    Examples:
        >>> from parqdb.datafusion.ipc import get_worker_ctx, clear_worker_ctx
        >>> clear_worker_ctx()
        >>> get_worker_ctx() is None
        True
    """
...
def set_sender_ctx(ctx: SessionContext) -> None:
    ...
    Examples:
        >>> from parqdb.datafusion import SessionContext
        >>> from parqdb.datafusion.ipc import set_sender_ctx, get_sender_ctx
...
def clear_sender_ctx() -> None:
    ...
    Examples:
        >>> from parqdb.datafusion import SessionContext
        >>> from parqdb.datafusion.ipc import (
...
def get_sender_ctx() -> SessionContext | None:
    ...
    Examples:
        >>> from parqdb.datafusion.ipc import get_sender_ctx, clear_sender_ctx
        >>> clear_sender_ctx()
        >>> get_sender_ctx() is None
        True
    """
...
def _resolve_ctx(
    ...
    Examples:
        >>> from parqdb.datafusion import SessionContext
        >>> from parqdb.datafusion.ipc import _resolve_ctx, clear_worker_ctx
        >>> clear_worker_ctx()
    ...
    from parqdb.datafusion.context import SessionContext  # noqa: PLC0415
