...
if TYPE_CHECKING:
    ...
    from parqdb.datafusion import DataFrame, SessionContext
    from parqdb.datafusion.context import TableProviderExportable
    from parqdb.datafusion.expr import CreateExternalTable
