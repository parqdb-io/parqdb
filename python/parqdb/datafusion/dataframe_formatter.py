...
def get_formatter() -> DataFrameHtmlFormatter:
    ...
    Example:
        >>> from parqdb.datafusion.dataframe_formatter import get_formatter
...
def set_formatter(formatter: DataFrameHtmlFormatter) -> None:
    ...
    Example:
        >>> from parqdb.datafusion.dataframe_formatter import get_formatter, set_formatter
...
def configure_formatter(**kwargs: Any) -> None:
    ...
    Example:
        >>> from parqdb.datafusion.dataframe_formatter import configure_formatter
        >>> configure_formatter(
        ...     max_cell_length=50,
        ...     max_height=500,
...
def reset_formatter() -> None:
    ...
    Example:
        >>> from parqdb.datafusion.dataframe_formatter import reset_formatter
