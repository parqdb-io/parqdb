...
import parqdb.datafusion._internal as df_internal
from parqdb.datafusion import SessionContext
from parqdb.datafusion.expr import Expr
...
class ScalarUDF:
    ...
    def name(self) -> str:
        ...
        Examples:
            >>> import pyarrow as pa
            >>> from parqdb.datafusion import udf
            >>> double = udf(
    ...
    def udf(*args: Any, **kwargs: Any):  # noqa: D417
        ...
        Examples:
            ...
            >>> from parqdb.datafusion.user_defined import ScalarUDF
            >>> def double_func(x):
...
class AggregateUDF:
    ...
    def udaf(*args: Any, **kwargs: Any):  # noqa: D417, C901
        ...
        Examples:
            >>> import pyarrow.compute as pc
            >>> from parqdb.datafusion.user_defined import AggregateUDF, Accumulator, udaf
...
class WindowUDF:
    ...
    def udwf(*args: Any, **kwargs: Any):  # noqa: D417
        ...
        Examples:
            >>> from parqdb.datafusion.user_defined import WindowUDF, WindowEvaluator, udwf
