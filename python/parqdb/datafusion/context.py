...
from parqdb.datafusion.catalog import (
    Catalog,
    CatalogList,
...
from parqdb.datafusion.dataframe import DataFrame
from parqdb.datafusion.expr import sort_list_to_raw_sort_list
from parqdb.datafusion.options import (
    DEFAULT_MAX_INFER_SCHEMA,
    CsvReadOptions,
    _convert_table_partition_cols,
)
from parqdb.datafusion.record_batch import RecordBatchStream
...
if TYPE_CHECKING:
    ...
    from parqdb.datafusion.catalog import CatalogProvider, Table
    from parqdb.datafusion.common import DFSchema
    from parqdb.datafusion.expr import Expr, SortKey
    from parqdb.datafusion.plan import ExecutionPlan, LogicalPlan
    from parqdb.datafusion.user_defined import (
        AggregateUDF,
...
class SessionContext:
    ...
    def udf(self, name: str) -> ScalarUDF:
        ...
        Examples:
            ...
            {'is_null': [False, True, False]}
        """
        from parqdb.datafusion.user_defined import ScalarUDF as _ScalarUDF  # noqa: PLC0415
    ...
    def udaf(self, name: str) -> AggregateUDF:
        ...
        Examples:
            ...
            {'total': [6]}
        """
        from parqdb.datafusion.user_defined import (  # noqa: PLC0415
    ...
    def udwf(self, name: str) -> WindowUDF:
        ...
        Examples:
            ...
            {'a': [10, 20, 30], 'rn': [1, 2, 3]}
        """
        from parqdb.datafusion.user_defined import WindowUDF as _WindowUDF  # noqa: PLC0415
    ...
    def parse_sql_expr(self, sql: str, schema: DFSchema) -> Expr:
        ...
        """
        from parqdb.datafusion.expr import Expr  # noqa: PLC0415
    ...
    def table_provider(self, name: str) -> Table:
        ...
        Examples:
            ...
            x: int64
        """
        from parqdb.datafusion.catalog import Table  # noqa: PLC0415
    ...
    def with_python_udf_inlining(self, *, enabled: bool) -> SessionContext:
        ...
        * **Safer deserialization.** :meth:`Expr.from_bytes` will refuse
        ...
        Examples:
            >>> import pyarrow as pa
            >>> from parqdb.datafusion import SessionContext, Expr, col, udf
            >>> ctx = SessionContext()
